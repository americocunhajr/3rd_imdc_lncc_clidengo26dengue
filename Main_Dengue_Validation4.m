...
for j = 1:Nufs
    ...
    % Number of epidemiological weeks for validation test
    nEW2 = length(dates_valid);
    ...
    dC_valid_low      = zeros(4,nEW2);
    dC_valid_upp      = zeros(4,nEW2);
    ...
    C_valid_low      = zeros(4,nEW2);
    C_valid_upp      = zeros(4,nEW2);
    ...
    % graphObj1.title     = 'Validation Test 4: 2025-2026 Season';
    ...
    % graphObj2.title     = 'Validation Test 4: 2025-2026 Season';
